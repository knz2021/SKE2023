...
function clickDisplay6() {
  ...
  element.innerHTML = "６　天使が驚いたのはどの日？";
  element.style.backgroundColor = "pink";
}
...
function clickDisplay18() {
  const element = document.getElementById("text-button18");
  element.innerHTML = "１８　ルカ4:16-21";
  element.style.backgroundColor = "pink";
}
...
function clickDisplay37() {
  const element = document.getElementById("text-button37");
  element.innerHTML = "３７　人類ゼロの危機";
  element.style.backgroundColor = "pink";
}
